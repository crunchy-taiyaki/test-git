...
!T.Bisbas, T.Bell
  ...
  use maincode_module, only : input, level, Tguess, v_turb_inp, iterstep,&
                              ...
                              & fieldchoice, Gext, UV_source_coord, AV_fac, UV_fac, nspec, nreac, &
  ...
  read(12,'(A)') indir !new line
  read(12,*) input
  read(12,'(A)') directory !new line
  read(12,*) output
  read(12,*) level
  read(12,*) theta_crit
  ...
  read(12,*) fieldchoice
  read(12,*) Gext
  read(12,*) UV_source_coord(1)
  read(12,*) UV_source_coord(2)
  read(12,*) UV_source_coord(3)
